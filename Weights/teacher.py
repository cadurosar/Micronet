...
def main():
    ...
    for epoch in range(200):
        ...
        test(net,testloader, device, save_name="BWN-Densenet1968",bc=bc)
...
#        test(net,testloader, device, save_name="Densenet1968")
    ...
    for epoch in range(5):
        print('Epoch: %d' % epoch)
        train(net,clean_trainloader,scheduler, device, optimizer,cutmix=False,mixup_alpha=0,bc=bc)
        test(net,testloader, device, save_name="BWN-Densenet1968-2",bc=bc)
