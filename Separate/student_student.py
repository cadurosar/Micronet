...
def main():
    ...
    net = torch.load("checkpoint/145_teacher_145_student.pth")["net"].module

#    net = ResNet14(wide=5,first_layer=16)
    net = net.to(device)
    teacher = torch.load("checkpoint/resnet145-2.pth")["net"]
    teacher.eval()
    ...
    for epoch in range(250):
        ...
        test(net,testloader, device, "145_teacher_145_student")
