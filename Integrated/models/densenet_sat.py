...
class SingleLayer(nn.Module):
    def __init__(self, nChannels, growthRate):
        ...
        self.conv1 = sat.ShiftAttention(nChannels, growthRate, kernel_size=3,
...
class Bottleneck(nn.Module):
    def __init__(self, in_planes, growth_rate):
        ...
        if groups:
            ...
            self.conv2 = sat.ShiftAttention(4*growth_rate, growth_rate, kernel_size=3, padding=1, bias=False)
