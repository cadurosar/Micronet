...
def main():
    ...
    clean_trainloader, trainloader, testloader = load_data(100, cutout=False)
    net = ResNet110(wide=10,first_layer=16)
    net = net.to(device)
    if device == 'cuda':
    ...
    for epoch in range(200):
        ...
        test(net,testloader, device, save_name="resnet11010")
